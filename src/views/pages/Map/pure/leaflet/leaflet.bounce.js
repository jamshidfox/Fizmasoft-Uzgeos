      ...
      [
        {
          ...
          value: function findOpacity(options) {
            this.opacity =
              (options === null || options === void 0 ? void 0 : options.opacityWhenUnclustered) || // used by cluster plugin
              (options === null || options === void 0 ? void 0 : options.opacity) ||
              1
          }
          /**
      ...
      [
        {
          ...
          value: function toFormat() {
            ...
            var fnBody = _classPrivateFieldGet(this, _matrix)
      ...
      [
        {
          ...
          value: function recalculateMotion(position) {
            ...
            var iconHeight =
              ((_this$marker$getIcon = this.marker.getIcon()) === null || _this$marker$getIcon === void 0
                ? void 0
                : (_this$marker$getIcon$ = _this$marker$getIcon.options) === null || _this$marker$getIcon$ === void 0
                ? void 0
                : _this$marker$getIcon$.iconSize[1]) ||
              ((_this$marker = this.marker) === null || _this$marker === void 0
                ? void 0
                : (_this$marker$_iconObj = _this$marker._iconObj) === null || _this$marker$_iconObj === void 0
                ? void 0
                : (_this$marker$_iconObj2 = _this$marker$_iconObj.options) === null || _this$marker$_iconObj2 === void 0
                ? void 0
                : _this$marker$_iconObj2.iconSize[1])
            var x = position.x,
              y = position.y
            var _this$bouncingOptions = this.bouncingOptions,
              bounceHeight = _this$bouncingOptions.bounceHeight,
            ...
            if (this.marker._shadow) {
              ...
              var shadowHeight =
                (_this$marker$getIcon2 = this.marker.getIcon()) === null || _this$marker$getIcon2 === void 0
                  ? void 0
                  : (_this$marker$getIcon3 = _this$marker$getIcon2.options) === null || _this$marker$getIcon3 === void 0
                  ? void 0
                  : _this$marker$getIcon3.shadowSize?.[1]
        ...
        },
        {
          key: "makeMoveStep",
          value: function makeMoveStep(step) {
            if (this.marker && this.marker._icon) this.marker._icon.style.cssText = this.iconStyles.withTransform(this.iconMoveTransforms[step]).toString()
        ...
        },
        {
          ...
          value: function makeResizeStep(step) {
            if (this.marker && this.marker._icon) this.marker._icon.style.cssText = this.iconStyles.withTransform(this.iconResizeTransforms[step]).toString()
      ...
      [
        ...
        },
        {
          ...
          value: function calculateShadowResizeTransforms(x, y, width, height, contractHeight) {
            ...
            while (deltaHeight--) {
              transforms[deltaHeight] =
                " matrix3d(" + width / points[deltaHeight][0] + ",0,0,0,0," + points[deltaHeight][1] / height + ",0,0,0,0,1,0," + x + "," + (y + height - points[deltaHeight][1]) + ",0,1) "
            }
