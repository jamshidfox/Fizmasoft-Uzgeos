...
import { ArrowDown, Pocket} from 'react-feather'
...
const ApexLineChart = ({ direction, warning }) => {
  ...
  const series = [
    {
      data: [350, 330, 300, 320, 270, 250, 70, 90, 200, 150, 160, 100, 150, 100, 50]
    },
    {
      data: [290, 60, 140, 75, 100, 160, 200, 120, 250, 190, 260, 290, 270, 250, 100]
      ...
      <CardHeader className='d-flex flex-sm-row flex-column justify-content-md-between align-items-start justify-content-start'>
        <div>
          <CardTitle className='mb-75' tag='h4'>
            <Pocket size = {20} className = "mr-2"/>
            Balance
          </CardTitle>
          <CardSubtitle className='text-muted mt-1'>Commercial networks & enterprises</CardSubtitle>
        </div>
